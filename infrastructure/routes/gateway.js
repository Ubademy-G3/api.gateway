...
router.route("/users/:id/favorites/rated").get(UsersController.getFavoriteCoursesWithRating);
...
router.route("/users/:id/certificates").get(UsersController.getCertificates);
